  ...
  const podManifest = {
    ...
    spec: {
      ...
      initContainers: [
        {
          name: "init-container",
          image: "155149245210.dkr.ecr.ap-south-1.amazonaws.com/template",
      ...
      containers: [
...

        {
          ...
          image: "155149245210.dkr.ecr.ap-south-1.amazonaws.com/agent",
          imagePullPolicy: "IfNotPresent",
          ports: [
            {
              containerPort: 3000,
        ...
        {
          image: "155149245210.dkr.ecr.ap-south-1.amazonaws.com/sync-agent",
